...
class SysFetch():
    ...
    def __init__(self, values):
        try:
            ...
            print("cloudmetrics: Error: Not enough permissions.")
    ...
    def generalInfo(self):
        ...
        if not all(info.values()):
            print("cloudmetrics: Info: Unable to collect some metrics.")
        self.info = info
        return self.info
    ...
    def check_interfaces(self):
        ...
        Return active interface names and IP addresses as a tuple of two separate lists.'''
        interface_names = []
        ip_addresses = []
    ...
    def logGeneral(self):
        ...
        if not os.path.isdir("logs/system_info"):
            try:
                ...
                print("cloudmetrics: Error: Unable to log reports. \nNot enough permissions.")
